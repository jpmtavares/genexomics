...
1. [Project Files](#project-files)
   - [condaenv.yml](#condaenvyml)
   - [Dockerfile](#dockerfile)
   - [Snakefile](#snakefile)
   - [snakeconfig.yml](#snakeconfigyml)
...
5. [Outputs](#outputs)
   ...
   - [Secondary Analysis](#secondary-analysis)
     - [Analysis Folder Tree Structure](#analysis-folder-tree-structure)
...
This pipeline is tested using a small test data provided by **10x Genomics** for **Cell Ranger** test runs.
